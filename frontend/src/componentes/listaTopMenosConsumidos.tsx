...
export const ListaTopMenosConsumidos = ({ tipo }: props) => {
    const [topMenosConsumidos, setTopMenosConsumidos] = useState<Array<[Item, number]>>([])
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                setTopMenosConsumidos(itemsWithDetails)
            } catch (error) {
